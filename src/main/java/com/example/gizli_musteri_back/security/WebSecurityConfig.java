package com.example.gizli_musteri_back.security;
...
import com.example.gizli_musteri_back.security.jwt.AuthEntryPointJwt;
import com.example.gizli_musteri_back.security.jwt.AuthTokenFilter;
import com.example.gizli_musteri_back.security.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/gizli-musteri/kaydet").permitAll() // public access
